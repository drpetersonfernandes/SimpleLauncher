...
public partial class InjectRaineConfigViewModel : ObservableObject
{
    ...
    public InjectRaineConfigViewModel(SettingsManagerService settings, IMessageBoxLibraryService messageBox, EmulatorPathResolver emulatorPathResolver, ILogger logger)
    {
        _settings = settings;
        _logger = logger;
    ...
    [RelayCommand]
    private async Task SelectNeoCdBios()
    {
    ...
    [RelayCommand]
    private async Task SelectRaineRomDirectory()
    {
