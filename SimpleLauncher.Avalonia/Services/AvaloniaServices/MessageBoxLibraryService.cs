...
public class MessageBoxLibraryService : IMessageBoxLibraryService
{
    ...
    public Task FailedToInjectYumirConfigurationMessageBoxAsync()
    {
        ...
        return ShowAsync(O, "Failed to save Yumir configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Mednafen configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"Error opening the Update History window.\n\n" + $"The error was reported to the developer who will try to fix the issue.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Raine executable not found. Please select it.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no flyer file associated with this game.", "Flyer not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Mesen configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Selected system not found in the XML document!", "Alert", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "'Simple Launcher' could not check disk space for the specified path. Please check the path and try again.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
...
if (result == MessageBoxResult.Yes)
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to start 'Simple Launcher'. An error occurred while checking for existing instances.", "Simple Launcher Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please reinstall 'Simple Launcher' manually to fix the issue.", "Warning", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Stella emulator not found. Please locate 'stella.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Supermodel emulator not found. Please locate 'Supermodel.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "The launch of the selected tool was canceled by the user.", "Info", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Mednafen configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "ReDream configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please enter your RetroAchievements username, API key, and password before configuring an emulator.", "Credentials Required", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject RetroArch configuration. The error has been logged. Please check the emulator path and try again.", "Injection Error", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save configuration. The error has been logged to the developer.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Mesen configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "SEGA Model 2 configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"The 7z dll is missing from the application folder!\n\n" + $"Do you want to reinstall 'Simple Launcher' to fix the issue?", "Error", MessageButtons.YesNo, MessageIcon.Question);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "An error occurred while configuring the emulator.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Azahar configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to log in to RetroAchievements. Please check your username and password.", "Login Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save ReDream configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject MAME configuration. The error has been logged.", "Injection Error", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"Failed to open the manual.\n\n" + $"The error was reported to the developer who will try to fix the issue.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "The file 'error_user.log' was not found!", launchError, MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "An error occurred while opening your browser.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Xenia configuration. The error has been logged.", "Injection Error", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Stella configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
...
public async Task<MessageBoxResult> ReallyWantToRemoveAllPlayHistoryMessageBoxAsync()
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "ReDream executable not found. Please select it.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    public async Task<MessageBoxResult> AreYouSureYouWantToDeleteTheCoverImageMessageBoxAsync(string fileNameWithoutExtension)
    {
        if (O == null) return MessageBoxResult.Cancel;
        return await ShowAsync(O, "", "", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please enter a system name before choosing an image.", "System Name Required", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Blastem emulator not found. Please locate 'blastem.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Flycast configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Another instance of 'Simple Launcher' is already running.", "Simple Launcher", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Azahar configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"System '{selectedSystemName}' has been deleted.", "Info", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Supermodel configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Xenia configuration. The error has been logged. Please check the emulator path and try again.", "Injection Error", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please select a system before using the Feeling Lucky feature.", "Warning", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "No games found to randomly select from. Please check your system selection.", "Feeling Lucky", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject configuration. The error has been logged to the developer.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Blastem configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Supermodel configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "You need to add RetroAchievement login information to use this feature.", "Attention", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to restart the application.", "Restart Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"Please reinstall 'Simple Launcher' manually to fix the issue.\n\nThe application will shutdown.", "Missing Required Files", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "RPCS3 emulator not found. Please locate 'rpcs3.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "The operation was cancelled.", "Operation Cancelled", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Ares configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save RPCS3 configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject RPCS3 configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Flycast emulator not found. Please locate 'flycast.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Cemu emulator not found. Please locate 'Cemu.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save DuckStation configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "The 'Group Files by Folder' option is only compatible with MAME emulators (Software List CHDs) or DOSBox emulators (uncompressed DOS game folders). To use a different emulator, please edit the system settings and disable this option.", "Compatibility Warning", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Raine configuration has been successfully injected.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Ares emulator not found. Please locate 'ares.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no PCB file associated with this game.", "PCB not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "SEGA Model 2 emulator not found. Please locate 'emulator.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "'Simple Launcher' could not open the download link.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "'Simple Launcher' does not support the current processor architecture. We only support 64-bit (x64) or ARM64. The application will now close.", "Unsupported Architecture", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Blastem configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "DuckStation emulator not found. Please locate the DuckStation executable.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Emulator configured successfully for RetroAchievements!", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    public async Task GeolithDoesNotSupportCompressedFilesMessageBoxAsync()
    {
        ...
        if (result == MessageBoxResult.Yes)
        {
            ...
            catch (Exception ex)
            {
                ...
                await ShowAsync(O, "Could not open browser: " + ex.Message, "Error", MessageButtons.Ok, MessageIcon.Error);
            }
        }
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Ares configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"An unexpected error occurred while initializing the 7-Zip library.\n\n" + $"Do you want to reinstall 'Simple Launcher' to fix the issue?", "Error", MessageButtons.YesNo, MessageIcon.Question);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Game launch timed out. Please try again or check if the emulator started.", "Game launch timed out", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "'Simple Launcher' could not find the updater application on GitHub.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Stella configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save settings. Please check that the application folder is writable and not locked by another process.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no cover file associated with this game.", "Cover not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Dolphin configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
...
public async Task ReinstallSimpleLauncherFileCorruptedMessageBoxAsync()
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Stella configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Ootake emulator does not support CHD, ISO, CUE/BIN files.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save SEGA Model 2 configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Flycast configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no gameplay snapshot file associated with this game.", "Gameplay Snapshot not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Dolphin emulator not found. Please locate 'Dolphin.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "RPCS3 configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Dolphin configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    public Task ProtocolHandlerNotRegisteredMessageBoxAsync(string protocol)
    {
        ...
        var message = string.Format(System.Globalization.CultureInfo.InvariantCulture,
            "Protocol handler for '{0}://' is not registered. Please ensure the associated application is installed.", protocol);
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Cannot take a screenshot of a minimized window.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Blastem configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Mesen emulator not found. Please locate 'Mesen.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "RetroArch emulator path not found. Please select 'retroarch.exe' to apply these settings.", "Emulator Required", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"The name '{emulatorName}' is used multiple times. Each emulator name must be unique.", "Info", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject MAME configuration. The error has been logged. Please check the emulator path and try again.", "Injection Error", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "'Simple Launcher' could not access the Web API to download the updated URLs. Please try again later.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Yumir executable not found. Please select it.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"The Dokan file system driver (dokan2.dll) is required to mount archives as virtual drives. It does not appear to be installed on this system.\n\nDo you want to open your browser to download Dokan?", "Error", MessageButtons.YesNo, MessageIcon.Question);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Could not open the temporary folder.", "Error Opening Folder", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Supermodel configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no walkthrough file associated with this game.", "Walkthrough not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "MAME configuration injected successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Daphne settings saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "DeadZone values reverted to default values.", "Info", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"The download could not be completed because the temporary file is locked by another process (e.g., antivirus software).\n\nWould you like to open the temporary folder to inspect the file?", "Download Failed", MessageButtons.YesNo, MessageIcon.Question);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Xenia configuration injected successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "The file 'system.xml' is locked or inaccessible by another process.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"No PDF viewer is installed on your system.\n\nPlease install a PDF viewer (such as Adobe Acrobat Reader, Sumatra PDF, or Microsoft Edge) to open this file.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please select a history item to remove.", "Please select a item", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Xenia emulator path not found. Please select 'xenia.exe' or 'xenia_canary.exe' to apply these settings.", "Emulator Required", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject SEGA Model 2 configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There was an error toggling the fuzzy matching logic.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Your operating system does not have a default web browser configured. Please set one in Windows Settings (Apps > Default apps) to open web links.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Yumir configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject Ares configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no cart file associated with this game.", "Cart not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Only PNG, JPG, and JPEG images are supported.", "Invalid Image Format", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Mednafen configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "MAME emulator path not found. Please select 'mame.exe' or 'mame64.exe' to apply these settings.", "Emulator Required", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please enter your RetroAchievements username and password first.", "Missing Information", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Could not open sound configuration window", "Warning", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no manual associated with this file.", "Manual not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Mesen configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to save Flycast configuration. Please check file permissions.", "Save Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject RetroArch configuration. The error has been logged.", "Injection Error", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please select a system before searching.", "Warning", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please enter the details of the support request.", "Info", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Download and extraction completed successfully.", "Info", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no cabinet file associated with this game.", "Cabinet not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Mednafen emulator not found. Please locate 'mednafen.exe'.", "Emulator Not Found", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please enter valid search terms.", "Invalid Search", MessageButtons.Ok, MessageIcon.Warning);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"Error opening the download link.\n\nThe error was reported to the developer who will try to fix the issue.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "'Simple Launcher' was unable to restore the last backup.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to inject DuckStation configuration. Please check file permissions and try again.", "Injection Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"Could not open the achievements window.\n\nThe error was reported to the developer who will try to fix the issue.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Dolphin configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, $"The file was downloaded successfully, but automatic extraction failed. This can happen if an antivirus program is scanning or locking the file.\n\nWould you like to open the temporary folder to inspect the file?", "Extraction Failed", MessageButtons.YesNo, MessageIcon.Question);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no Favorite for this system, or you have not chosen a system.", "Warning", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Failed to configure the emulator. The configuration file might be missing, in an unexpected location, or read-only.", "Configuration Failed", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "DuckStation configuration saved successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no video file associated with this game.", "Video not found", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "RetroArch configuration injected successfully.", "Success", MessageButtons.Ok, MessageIcon.Information);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "Please reinstall 'Simple Launcher' manually to fix the issue.", "Error", MessageButtons.Ok, MessageIcon.Error);
    }
    ...
    {
        if (O == null) return Task.CompletedTask;
        return ShowAsync(O, "There is no title snapshot file associated with this game.", "Title Snapshot not found", MessageButtons.Ok, MessageIcon.Information);
    }
