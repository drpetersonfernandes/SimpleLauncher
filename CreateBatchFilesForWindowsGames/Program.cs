...
static class Program
{
    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            var batchFilePath = GetBatchFilePath(gameFolderPath);
            ...
            var result = MessageBox.Show("Do you want to create another batch file?", "Continue", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
