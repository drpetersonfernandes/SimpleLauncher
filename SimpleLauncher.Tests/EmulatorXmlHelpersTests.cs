...
public class EmulatorXmlHelpersTests
{
    ...
    {
        var result = EmulatorXmlHelpers.ReadBool(Section, "SystemConfig", Root, "Fullscreen", false);
        Assert.True(result);
    }
    ...
    public void ReadBool_FallsBackToFlattenedRootElement()
    {
        ...
        var result =
            EmulatorXmlHelpers.ReadBool(sectionWithoutProperty, "SystemConfig", Root, "Fullscreen", false);
        Assert.False(result);
    }
    ...
    public void ReadBool_InvalidValueUsesFallback()
    {
        ...
        var result = EmulatorXmlHelpers.ReadBool(null, "SystemConfig", root, "Fullscreen", true);
        Assert.True(result);
    }
    ...
    {
        var result = EmulatorXmlHelpers.ReadInt(Section, "SystemConfig", Root, "MaxPlayers", 0);
    ...
    {
        var result = EmulatorXmlHelpers.ReadInt(null, "SystemConfig", Root, "MaxPlayers", 0);
    ...
    public void ReadInt_InvalidValueUsesFallback()
    {
        ...
        var result = EmulatorXmlHelpers.ReadInt(null, "SystemConfig", root, "MaxPlayers", 8);
    ...
    public void ReadDouble_SectionValueParsedWithInvariantCulture()
    {
        ...
        var result = EmulatorXmlHelpers.ReadDouble(section, "SystemConfig", Root, "Volume", 0);
    ...
    public void ReadDouble_InvalidValueUsesFallback()
    {
        ...
        var result = EmulatorXmlHelpers.ReadDouble(section, "SystemConfig", Root, "Volume", 1.0);
    ...
    {
        var result = EmulatorXmlHelpers.ReadString(Section, "SystemConfig", Root, "RomPath", "");
    ...
    {
        var result = EmulatorXmlHelpers.ReadString(null, "SystemConfig", Root, "RomPath", "");
    ...
    {
        var result = EmulatorXmlHelpers.ReadString(null, "SystemConfig", Root, "DoesNotExist", "default");
    ...
    {
        var root = new XElement("Config");
        var result = EmulatorXmlHelpers.ReadString(null, "SystemConfig", root, "RomPath", "fallback-path");
