...
dotnet publish -c Release -r win-x86 --self-contained false -p:PublishSingleFile=true -o ./publish/win-x86
if %errorlevel% neq 0 (
...
dotnet publish -c Release -r win-arm64 --self-contained false -p:PublishSingleFile=true -o ./publish/win-arm64
if %errorlevel% neq 0 (
