...
public interface IDisplaySystemInformation
{
    ...
    Task<SystemValidationResult> DisplaySystemInfoAsync(SystemManagerService selectedManager,
    ...
    /// <returns>The result of the system validation.</returns>
    SystemValidationResult ValidateSystemConfiguration(SystemManagerService selectedManager);
}