...
public class StellaConfigHandler : IEmulatorConfigHandler
{
    ...
    /// </summary>
    public StellaConfigHandler(ILogErrors logErrors, ILogger logger, IServiceScopeFactory scopeFactory)
    {
    ...
    public async Task<bool> HandleConfigurationAsync(LaunchContext context)
    {
        if (context.EmulatorManager != null)
        {
            ...
            if (context.Settings != null && context.Settings.Stella.ShowSettingsBeforeLaunch)
            {
            ...
            {
                shouldRun = true;
                if (File.Exists(resolvedExe)) StellaConfigurationService.InjectSettings(resolvedExe, context.Settings, _logErrors, _logger);
            }
