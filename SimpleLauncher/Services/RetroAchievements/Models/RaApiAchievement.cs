...
public record RaApiAchievement
{
    ...
    private static DateTime? ParseDate(string dateString)
    {
        ...
        App.ServiceProvider.GetRequiredService<ILogErrors>().LogAndForget(new FormatException($"Failed to parse RetroAchievements API date string: '{dateString}'"), "RetroAchievements API date parsing error in RaApiAchievement.");
        return null;
    }
