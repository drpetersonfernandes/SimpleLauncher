...
public interface ISystemSelectionHost
{
    ...
    List<SimpleLauncher.Services.SystemManager.SystemManager> GetSystemManagers();
    void SetSystemManagers(List<SimpleLauncher.Services.SystemManager.SystemManager> managers);
