...
/// Ported from SimpleLauncher's EditSystemWindow — same validation pipeline and save semantics,
...
public partial class EditSystemWindow
{
    ...
    {
        var dialog = new OpenFolderDialog { Title = "Please select the System Folder" };
        if (dialog.ShowDialog() == true)
        {
            SystemFolderTextBox.Text = dialog.FolderName;
    ...
    {
        var dialog = new OpenFolderDialog { Title = "Please select the System Image Folder" };
        if (dialog.ShowDialog() == true)
        {
            SystemImageFolderTextBox.Text = dialog.FolderName.Trim();
    ...
    private static void ChooseEmulatorPath(TextBox pathTextBox)
    {
    ...
    {
        var dialog = new OpenFolderDialog { Title = "Please select an additional System Folder" };
        if (dialog.ShowDialog() == true)
        {
            AdditionalFoldersListBox.Items.Add(dialog.FolderName);
        }
    }
