...
public partial class InjectBlastemConfigViewModel : ObservableObject
{
    ...
    public InjectBlastemConfigViewModel(SettingsManagerService settings, IMessageBoxLibraryService messageBox, ILogger logger, EmulatorPathResolver emulatorPathResolver)
    {
        _settings = settings;
        _logger = logger;
