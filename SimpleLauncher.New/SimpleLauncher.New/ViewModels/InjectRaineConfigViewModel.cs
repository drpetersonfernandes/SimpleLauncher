...
public partial class InjectRaineConfigViewModel : ObservableObject
{
    ...
    public InjectRaineConfigViewModel(SettingsManagerService settings, IMessageBoxLibraryService messageBox, ILogger logger, EmulatorPathResolver emulatorPathResolver)
    {
        _settings = settings;
        _logger = logger;
