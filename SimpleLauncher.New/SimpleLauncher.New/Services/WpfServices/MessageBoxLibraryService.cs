...
using WMBtn = System.Windows.MessageBoxButton;
using WMImg = System.Windows.MessageBoxImage;
using WMRes = System.Windows.MessageBoxResult;
...
public class MessageBoxLibraryService : IMessageBoxLibraryService
{
    ...
    {
        if (O != null) WMB.Show(O, "Press Print Screen to capture a screenshot.", "Screenshot", WMBtn.OK, WMImg.Information);
