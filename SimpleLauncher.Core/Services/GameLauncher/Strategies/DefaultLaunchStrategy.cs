...
public class DefaultLaunchStrategy : ILaunchStrategy
{
    ...
    public Task ExecuteAsync(LaunchContext context, ILauncherService launcher)
    {
        ...
        {
            case ".BAT":
                return launcher.RunBatchFileAsync(context.ResolvedFilePath, context.EmulatorManager!,
                    context.WindowContext!);
            case ".LNK":
            case ".URL":
                return launcher.LaunchShortcutFileAsync(context.ResolvedFilePath, context.EmulatorManager!,
                    context.WindowContext!);
            case ".EXE":
                return launcher.LaunchExecutableAsync(context.ResolvedFilePath, context.EmulatorManager!,
                    context.WindowContext!);
            default:
