...
public static class XeniaConfigurationService
{
    public static void InjectSettings(string emulatorPath, Core.Services.SettingsManager.SettingsManager settings, ILogErrors logErrors, IDebugLogger debugLogger)
    {
        ...
        foreach (var fileName in configFiles)
        {
            ...
            if (UpdateSingleConfigFile(configPath, settings, logErrors, debugLogger))
            {
                processedCount++;
            }
        }
    ...
    private static bool UpdateSingleConfigFile(string configPath, Core.Services.SettingsManager.SettingsManager settings, ILogErrors logErrors, IDebugLogger debugLogger)
    {
