...
public static class DolphinConfigurationService
{
    ...
    private static void InjectIntoConfigFile(string configPath, Core.Services.SettingsManager.SettingsManager settings, ILogErrors logErrors, IDebugLogger debugLogger)
    {
